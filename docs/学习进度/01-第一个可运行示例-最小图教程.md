...
[`SimpleState`](../../src/main/java/com/example/langgraph4jdemo/SimpleState.java) 是这个图共享的数据结构。
...
核心代码在 [`SimpleGraphService`](../../src/main/java/com/example/langgraph4jdemo/SimpleGraphService.java)：
